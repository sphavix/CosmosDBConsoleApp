...
public class Program
{
    ...
    private string databaseId = "consoleAppDb";
    private string containerId = "consoleAppContainer";
    ...
    {
        this.Database = await this._client.CreateDatabaseIfNotExistsAsync(databaseId);
